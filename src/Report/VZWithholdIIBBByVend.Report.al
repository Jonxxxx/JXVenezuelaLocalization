report 84124 JXVZWithholdIIBBByVend
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = 'ReportLayout/VZWithholdIIBBByVend.rdl';
                ...
                if JXVZVendorWithholdCondition.FindSet() then
                    repeat
                        ...
                        if JXVZWithholdingTax.FindFirst() then
                            if (JXVZWithholdingTax.JXVZTaxType = JXVZWithholdingTax.JXVZTaxType::"IB-ISLR") or
                                (JXVZWithholdingTax.JXVZTaxType = JXVZWithholdingTax.JXVZTaxType::"IB-Municipal") or
