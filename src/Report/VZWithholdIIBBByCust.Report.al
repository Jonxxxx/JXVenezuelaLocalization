report 84123 JXVZWithholdIIBBByCust
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = 'ReportLayout/VZWithholdIIBBByCust.rdl';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            begin
                TaxGroup.Reset();
                TaxGroup.SetFilter(Code, '%1|%2', 'IVA 21%', 'IVA16%');//Always find 21%
                ...
                if TaxArea.FindFirst() then begin
                    ...
                    if TaxAreaLine.FindSet() then
                        repeat
                            ...
                            TaxJurisdiction.SetRange(JXVZTaxType, TaxJurisdiction.JXVZTaxType::Withold);
        ...
        dataitem(Integer; Integer)
        {
            ...
            { }
            column(ISLR; JXVZExportFilesTmp.Field4)
            { }
            column(Municipal; JXVZExportFilesTmp.Field5)
            { }
