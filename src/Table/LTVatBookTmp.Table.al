table 84132 JXVZVatBookTmp
{
    ...
    fields
    {
        ...
        field(12; JXVZVAT105; Decimal)
        {
            DataClassification = OrganizationIdentifiableInformation;
            Caption = 'VAT 10,5', Comment = 'ESP=IVA 10,5';
        }
        field(13; JXVZVAT21; Decimal)
        {
            DataClassification = OrganizationIdentifiableInformation;
        ...
        field(16; JXVZIIBB; Decimal)
        {
            DataClassification = OrganizationIdentifiableInformation;
            Caption = 'Gross income', Comment = 'ESP=Ingresos brutos';
        }
        ...
        field(26; JXVZIIBBCaba; Decimal)
        {
            DataClassification = OrganizationIdentifiableInformation;
            Caption = 'Gross income Caba', Comment = 'ESP=Ingresos brutos Caba';
        }

        field(27; JXVZIIBBArba; Decimal)
        {
            DataClassification = OrganizationIdentifiableInformation;
            Caption = 'Gross income Arba', Comment = 'ESP=Ingresos brutos Arba';
        }
